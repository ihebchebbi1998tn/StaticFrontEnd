...
export function ServiceOrderPDFPreviewModal({
  ...
  useEffect(() => {
    const savedSettings = localStorage.getItem('service-order-pdf-settings');
    if (savedSettings) {
      try {
          ...
          try {
            ...
            if (onboardRaw) {
              ...
              if (candidate && typeof candidate === 'string') {
                ...
                try {
                  localStorage.setItem('service-order-pdf-settings', JSON.stringify(parsed));
                } catch (e) {
  ...
  useEffect(() => {
    localStorage.setItem('service-order-pdf-settings', JSON.stringify(pdfSettings));
